    ...
    <tbody>
        <c:forEach var="genero" items="${generos}">
            <tr>
                ...
                <td aling="left">${genero.descricaoGenero}</td>
                <td align="center">
        <a href=
           "${pageContext.request.contextPath}/GeneroExcluir?idGenero=${genero.idGenero}">
            Excluir</a></td>
            <td align="center">
                <a href=
                   "${pageContext.request.contextPath}/GeneroCarregar?idGenero=${genero.idGenero}">
                    Alterar</a></td>
            </tr>
        </c:forEach>
    </tbody>
